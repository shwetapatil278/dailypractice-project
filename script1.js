...
*/
let full_name = "Mansi Gaikwad";
console.log("Your full name is:" + full_name);
full_name = prompt("Enter your new full name");
console.log("Enter your new full name:" + full_name);

var fav_color;
fav_color = "Black";
console.log("Your favorite color is:" + fav_color);
fav_color = prompt("Enter your new favorite color");
console.log("Enter your new favorite color:" + fav_color);
...
*/
{
    ...
    var food = prompt("Enter the food name:");
}
...
*/
const fav_number = 18;
console.log("My favorite number is :" + fav_number  + " , Cannot be change.");
